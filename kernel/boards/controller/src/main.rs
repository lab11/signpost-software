...
impl Platform for SignpostController {
        ...
        where F: FnOnce(Option<&kernel::Driver>) -> R
    {
        ...
        match driver_num {
            ...
            //how do you standardize multiple numbers??
            0x81004 => f(Some(self.coulomb_counter_i2c_mux_0)),
            0x81005 => f(Some(self.coulomb_counter_i2c_mux_1)),
            0x81006 => f(Some(self.coulomb_counter_i2c_mux_2)),
